  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-fog text-plum">
      ...
      <header className="relative z-10 mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-4">
        ...
        <span className="hidden rounded-full border border-warm-silver/60 bg-warm-wash px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-olive sm:inline">
          Customer feedback
        </span>
      </header>
